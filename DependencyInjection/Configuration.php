	...
	public function getConfigTreeBuilder()
	{
		...
		$rootNode
			->children()
				...
				// ->end()
				->scalarNode('main_site_home')
					// ->defaultValue('acme_site_home')
					->isRequired()
					->cannotBeEmpty()
				...
				->scalarNode('user_class')
					...
					->info('Classe pour FOS/User')
				->end()
				->scalarNode('labo_bundle')
					->defaultValue('AcmeGroupLaboBundle')
					->isRequired()
					->cannotBeEmpty()
					->info('Bundle étendant labo')
				->end()
				...
				->arrayNode('launch_service')
					...
					->children()
						...
						->end()
					->end()
					->info('Services à lancer par l\'event_listener')
				->end()
