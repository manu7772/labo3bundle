...
class twigAetools extends Twig_Extension {
	...
	public function getFunctions() {
		return array(
			...
			'plur'				=> new \Twig_Function_Method($this, 'plur'),
			// remplissages
			...
			// fonctionnalités de noms de fichiers
			'changeExt'			=> new \Twig_Function_Method($this, 'changeExt'),
			// sites extérieurs
	...
	/**
	* Change l'extension du nom d'un fichier. Si l'extension n'est pas valide, retourne le nom du fichier $nom
